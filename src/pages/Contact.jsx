...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('Unable to send your request. Please call us at (720) 336-2152.');
    } finally {
      setSubmitting(false);
    }
  };
    ...
    <div className="contact-page">
      ...
      <section className="page-hero">
        <div className="container page-hero__content">
          ...
          <h1>Contact Us</h1>
          <p>Fill out the form or give us a call. We respond within 24 hours.</p>
        </div>
      </section>
          ...
          <div className="contact-grid">
            ...
            <div className="contact-form-wrap">
              ...
              <p className="contact-form-wrap__subtitle">
                Tell us what you need cleaned. Include photos if you can, and we'll send a quote within 24 hours.
              </p>
              ...
              {submitted ? (
                <div className="contact-success">
                  ...
                  <h3>Thank You!</h3>
                  <p>We got your message. Expect a response within 24 hours.</p>
                ...
                <form className="contact-form" onSubmit={handleSubmit}>
                  ...
                  <button type="submit" className="btn btn-primary btn-large contact-form__submit" disabled={submitting}>
            ...
            <div className="contact-sidebar">
              ...
              <div className="contact-info-card contact-info-card--dark">
                <h3>Follow Us</h3>
                <p>Before/after photos, cleaning tips, and seasonal deals.</p>
                <div className="contact-social">
                  <a href="https://www.facebook.com/AvalanchePowerClean" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                    <svg viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                  </a>
                  <a href="https://www.instagram.com/avalanchepowerclean/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                  ...
                  <a href="https://www.tiktok.com/@avalanchepowerclean" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
                    <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/></svg>
                  </a>
                  <a href="https://www.youtube.com/@avalanchepowerclean" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                    <svg viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                  </a>
                  <a href="https://www.yelp.com/biz/avalanche-power-clean-parker" target="_blank" rel="noopener noreferrer" aria-label="Yelp">
              ...
              <div className="contact-info-card">
                ...
                <p>Send us photos of the areas you need cleaned. We'll quote the job without an on-site visit.</p>
            ...
            {[
              {
                ...
                a: 'Most residential jobs take 2-4 hours. Larger properties or bundled services may take a full day. Your quote includes a time estimate.'
              },
              {
                q: 'Will pressure washing damage my surfaces?',
                a: 'We match the method to the surface. Soft wash for roofs and siding, adjusted pressure for concrete and stone. Our technicians train on this before they work on customer properties.'
              },
              {
                q: 'Do I need to be home during the service?',
                a: 'No. We need access to water and the cleaning area. We send before-and-after photos when the job is done.'
              },
              {
                q: 'How often should I have my home pressure washed?',
                a: 'Once a year for most Denver homes. Properties with heavy tree coverage or north-facing walls may need it twice.'
              },
              {
                q: 'Are your cleaning solutions safe for plants and pets?',
                a: 'Yes. We use biodegradable cleaning agents. We pre-wet your plants before we start and rinse them after.'
              },
              {
                q: 'Do you offer any guarantees?',
                a: 'Yes. If you\'re not happy with the results, we come back and redo it at no charge.'
              }
            ].map((faq, i) => (
